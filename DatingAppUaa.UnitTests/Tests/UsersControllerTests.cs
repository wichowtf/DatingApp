...
namespace DatingAppUaa.UnitTests.Pruebas
{
    public class UsersControllerTests
    {
        ...
        public async Task getUsersNoPaginationSuccess(string statusCode, string username, string password)
        {
            // Arrange
        ...
        public async Task getUsersWithPaginationSuccess(string statusCode, string username, string password, int pageSize, int pageNumber)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
        ...
        public async Task getUserByUsernameSuccess(string statusCode, string username, string password)
        {
            // Arrange
            var user = await LoginHelper.LoginUser(username, password);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", user.Token);
        ...
        public async Task addPhotoSuccess(string statusCode, string username, string password, string file)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
        ...
        public async Task setMainPhotoSuccess(string statusCode, string username, string password, string file)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
        ...
        public async Task deletePhoto(string statusCode, string username, string password,string file)
        {
            // Arrange
            var user = await LoginHelper.LoginUser(username, password);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", user.Token);
        ...
        public async Task deletePhotoFail(string statusCode, string username, string password, string id)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
